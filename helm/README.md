...
![Version: 5.0.16](https://img.shields.io/badge/Version-5.0.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 13.16.0](https://img.shields.io/badge/AppVersion-13.16.0-informational?style=flat-square)
...
| image.tag | string | `"version-13.16.0-nonroot"` | Docker image tag/version to deploy |
